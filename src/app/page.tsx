...
5. Generate the bcrypt hash with caddy hash-password, generate a strong password, and verify HTTPS, CORS preflight, PROPFIND, authentication, and a temporary write/delete.
